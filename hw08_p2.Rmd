...
# can retrieve stored dataframe & use in following code
# wip_manga <- read_csv("./wip_manga.csv")
...
```{r test_func}
one_multiple_manga <- function(pg){
...
# stores dataframe
wip_manga %>%
  write_csv(glue("./one_stored_df_pg{pg}.csv"))
